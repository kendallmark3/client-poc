 ...
 \connect $APP_DB_NAME $APP_DB_USER
  BEGIN;
   CREATE TABLE IF NOT EXISTS event (
	...
	insert into event (id,aggregate_id,event_data,version) values ('11111111111111111111111111','11111111111111111111111111','{"gender": "M","dob": 1991,"account_credit": 4480.90}',1);
  COMMIT;
EOSQL
